...
def main():
    ...
    print(f'\nSource Unicode-64 Values: {[ord(char) for char in input_string]}\n')
    ...
    print(f'\nEncrypted Unicode-64 Values: {[ord(char) for char in encrypted_string]}\n')
    ...
    print(f'\nDecrypted Unicode-64 Values: {[ord(char) for char in decrypted_string]}')
